...
1. Read in the sample informattion and count data.
...
bm<-getBM(attributes=c('ensembl_gene_id',"gene_biotype" ,"description" ,'mgi_symbol'),filters ='ensembl_gene_id',values=rownames(res1), mart=mart)
...
```{r,eval=TRUE,echo=TRUE}
plotCounts(dds,gene=which.min(res1$padj),intgroup="condition")
